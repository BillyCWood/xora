        ...
        <div className="container py-10 text-left">
            <div className="flex w-full max-md:flex-col">
                <div className="small-compact flex flex-1 flex-wrap items-center justify-center gap-5">
                    <p className="opacity-70">Copyright, Xora 2024</p>
                    
                </div>
                <div className="flex items-center justify-center sm:ml-auto">
                        <p className="cursor-pointer legal-after relative mr-9 text-p5 transition-all duration-500 hover:text-p1">Privacy Policy</p>
