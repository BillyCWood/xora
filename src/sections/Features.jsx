        ...
        <Element name="features">
            <div className="container text-left">
                <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
                    ...
                    <ul className="relative flex w-full justify-around flex-grou px-[5%] border-2 border-s3 rounded-7xl max-md:hidden">
                        ...
                        {details.map(({id, icon, title}) => (
                            <li key={id} className="relative pt-16 px-4 pb-14">
                                ...
                                <div className="flex items-center justify-center mx-auto mb-3 border-2 border-s2 rounded-full hover:border-s4 transition-all duration-500 shadow-500 size-20">
                                    <img src={icon} alt={title} className="size-17/20 object-contain z-20"></img>
                                </div>
